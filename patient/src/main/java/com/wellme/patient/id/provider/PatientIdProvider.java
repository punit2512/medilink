 ...
 */
@Component
public class PatientIdProvider extends IdSequenceProvider<BigInteger> {
	 ...
	 */
	public PatientIdProvider(
			@Named("sequenceIdSourceMongo") SequenceIdSource<BigInteger> sequenceIdSource, 
			@Value("${patient.id.sequence.name:patient.seq}") String sequenceIdentifier, 
